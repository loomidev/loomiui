...
export const fr: LoomiTranslations = {
  ...
  filepicker: {
    placeholderLine1: "Choisissez des fichiers ou glissez-déposez-les pour les téléverser",
    placeholderLine2: "%s jusqu'à %s",
    cropTitle: "Recadrer l'image",
    cropApply: "Appliquer",
    cropCancel: "Annuler",
    fileTooLargeTitle: "Fichier trop volumineux",
    fileTooLarge: '":name" dépasse la limite de :limit.',
  },
  select: {
  ...
  countries: {
    ...
    emptyPlaceholder: "Aucun pays trouvé",
    searchPlaceholder: "Rechercher un pays...",
    phoneNumberLabel: "Numéro de téléphone",
    selectCountryCode: "Sélectionner l'indicatif du pays",
  },
  table: {
    searchPlaceholder: "Rechercher...",
  ...
  photoGallery: {
    toolbar: "Barre d'outils de la galerie",
    showAlbums: "Afficher les albums",
    hideAlbums: "Masquer les albums",
    albums: "Albums",
    allAlbum: "Tous",
    zoomIn: "Zoomer",
    zoomOut: "Dézoomer",
    squareThumbnails: "Vignettes carrées",
    naturalThumbnails: "Vignettes naturelles",
    startSlideshow: "Démarrer le diaporama",
    stopSlideshow: "Arrêter le diaporama",
    empty: "Aucune photo à afficher",
    openPhoto: "Ouvrir la photo",
    favourite: "Ajouter aux favoris",
    unfavourite: "Retirer des favoris",
    dialog: "Visionneuse de photos",
    lightboxToolbar: "Barre d'outils de la visionneuse",
    counter: ":current sur :total",
    rotate: "Pivoter à gauche",
    share: "Partager la photo",
    close: "Fermer",
  ...
  otp: {
    ...
    digitLabel: "Chiffre :number",
    validating: "Vérification du code…",
    valid: "Code vérifié",
  },
  ...
  timepicker: {
    ...
    minute: "Minute",
    ampm: "AM/PM",
    toggleFormat: "Basculer le format 12/24 heures",
  },
  timezonepicker: {
    placeholder: "Sélectionner un fuseau horaire",
    emptyPlaceholder: "Aucun fuseau horaire trouvé",
    searchPlaceholder: "Rechercher un fuseau horaire...",
    detectLabel: "Utiliser mon fuseau horaire",
  },
  creditcard: {
    ...
    cvcLabel: "Code de sécurité",
    flipToBack: "Afficher le code de sécurité",
    flipToFront: "Retour à la carte",
  },

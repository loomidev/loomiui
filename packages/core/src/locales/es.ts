...
export const es: LoomiTranslations = {
  ...
  filepicker: {
    placeholderLine1: "Elige archivos o arrástralos para subirlos",
    placeholderLine2: "%s hasta %s",
  ...
  countries: {
    ...
    emptyPlaceholder: "No se encontraron países",
  ...
  table: {
    ...
    scrollRegion: "Tabla desplazable",
  },
  pagination: {
  ...
  photoGallery: {
    toolbar: "Barra de herramientas de la galería",
    showAlbums: "Mostrar álbumes",
    hideAlbums: "Ocultar álbumes",
    albums: "Álbumes",
    allAlbum: "Todas",
    zoomIn: "Acercar",
    zoomOut: "Alejar",
    squareThumbnails: "Miniaturas cuadradas",
    naturalThumbnails: "Miniaturas naturales",
    ...
    lightboxToolbar: "Barra de herramientas del visor de fotos",
    counter: ":current de :total",
    rotate: "Girar a la izquierda",
    share: "Compartir foto",
    close: "Cerrar",
  ...
  timezonepicker: {
    ...
    emptyPlaceholder: "No se encontraron zonas horarias",
    searchPlaceholder: "Buscar zonas horarias...",
    detectLabel: "Usar mi zona horaria",
  },
  creditcard: {
    ...
    flipToBack: "Mostrar código de seguridad",
    flipToFront: "Volver a la tarjeta",
  },

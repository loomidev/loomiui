...
export const de: LoomiTranslations = {
  ...
  filepicker: {
    placeholderLine1: "Dateien auswählen oder zum Hochladen hier ablegen",
    placeholderLine2: "%s bis %s",
    cropTitle: "Bild zuschneiden",
    cropApply: "Anwenden",
    cropCancel: "Abbrechen",
    fileTooLargeTitle: "Datei zu groß",
    fileTooLarge: '":name" überschreitet das Limit von :limit.',
  },
  select: {
    placeholder: "Auswählen",
    emptyPlaceholder: "Keine Optionen verfügbar",
    searchPlaceholder: "Suchen...",
  },
  countries: {
    placeholder: "Land auswählen",
    emptyPlaceholder: "Keine Länder gefunden",
    searchPlaceholder: "Länder suchen...",
    phoneNumberLabel: "Telefonnummer",
    selectCountryCode: "Landesvorwahl auswählen",
  },
  table: {
    searchPlaceholder: "Suchen...",
    noDataMessage: "Keine Einträge vorhanden",
    actionsTitle: "Aktionen",
    scrollRegion: "Scrollbare Tabelle",
  },
  pagination: {
    totalLabel: "Zeige :a bis :b von :c",
  ...
  photoGallery: {
    toolbar: "Galerie-Werkzeugleiste",
    showAlbums: "Alben anzeigen",
    hideAlbums: "Alben ausblenden",
    albums: "Alben",
    allAlbum: "Alle",
    zoomIn: "Vergrößern",
    zoomOut: "Verkleinern",
    squareThumbnails: "Quadratische Miniaturansichten",
    naturalThumbnails: "Natürliche Miniaturansichten",
    ...
    dialog: "Fotoanzeige",
    lightboxToolbar: "Werkzeugleiste der Fotoanzeige",
  ...
  otp: {
    errorMessage: "Der Bestätigungscode ist ungültig",
    digitLabel: "Ziffer :number",
    validating: "Code wird überprüft…",
    valid: "Code bestätigt",
  },
  ...
  timepicker: {
    ...
    minute: "Minute",
    ampm: "AM/PM",
    toggleFormat: "12/24-Stunden-Format umschalten",
  },
  timezonepicker: {
    placeholder: "Zeitzone auswählen",
    emptyPlaceholder: "Keine Zeitzonen gefunden",
    searchPlaceholder: "Zeitzonen suchen...",
    detectLabel: "Meine Zeitzone verwenden",
  },
  creditcard: {
    ...
    flipToBack: "Sicherheitscode anzeigen",
    flipToFront: "Zurück zur Karte",
  },

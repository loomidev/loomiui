...
export const pt_BR: LoomiTranslations = {
  ...
  filepicker: {
    placeholderLine1: "Escolha arquivos ou arraste e solte para enviar",
    placeholderLine2: "%s até %s",
    cropTitle: "Recortar imagem",
    cropApply: "Aplicar",
    cropCancel: "Cancelar",
    fileTooLargeTitle: "Arquivo muito grande",
    fileTooLarge: '":name" excede o limite de :limit.',
  },
  select: {
    placeholder: "Selecione",
    emptyPlaceholder: "Nenhuma opção disponível",
    searchPlaceholder: "Buscar...",
  },
  countries: {
    placeholder: "Selecione um país",
    emptyPlaceholder: "Nenhum país encontrado",
  ...
  table: {
    searchPlaceholder: "Buscar...",
    noDataMessage: "Nenhum registro para exibir",
    actionsTitle: "ações",
    scrollRegion: "Tabela rolável",
  },
  pagination: {
    totalLabel: "Mostrando :a a :b de :c",
  ...
  photoGallery: {
    toolbar: "Barra de ferramentas da galeria",
    showAlbums: "Mostrar álbuns",
    hideAlbums: "Ocultar álbuns",
    albums: "Álbuns",
    allAlbum: "Todas",
    zoomIn: "Aumentar zoom",
    zoomOut: "Diminuir zoom",
    squareThumbnails: "Miniaturas quadradas",
    naturalThumbnails: "Miniaturas naturais",
    startSlideshow: "Iniciar apresentação",
    stopSlideshow: "Parar apresentação",
    empty: "Nenhuma foto para mostrar",
    openPhoto: "Abrir foto",
    favourite: "Adicionar aos favoritos",
    unfavourite: "Remover dos favoritos",
    dialog: "Visualizador de fotos",
    lightboxToolbar: "Barra de ferramentas do visualizador",
    counter: ":current de :total",
    rotate: "Girar à esquerda",
    share: "Compartilhar foto",
    close: "Fechar",
  ...
  otp: {
    ...
    digitLabel: "Dígito :number",
    validating: "Verificando código…",
    valid: "Código verificado",
  },
  ...
  timepicker: {
    ...
    minute: "Minuto",
    ampm: "AM/PM",
    toggleFormat: "Alternar formato de 12/24 horas",
  },
  timezonepicker: {
    placeholder: "Selecione um fuso horário",
    emptyPlaceholder: "Nenhum fuso horário encontrado",
    searchPlaceholder: "Buscar fusos horários...",
    detectLabel: "Usar meu fuso horário",
  },
  creditcard: {
    ...
    cvcLabel: "Código de segurança",
    flipToBack: "Mostrar código de segurança",
    flipToFront: "Voltar ao cartão",
  },

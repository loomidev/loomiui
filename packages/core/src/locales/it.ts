...
export const it: LoomiTranslations = {
  ...
  filepicker: { placeholderLine1: "Scegli file o trascinali qui per caricarli", placeholderLine2: "%s fino a %s", cropTitle: "Ritaglia immagine", cropApply: "Applica", cropCancel: "Annulla" },

...
export const qualityOverrides = {
  ...
  "command-palette": {
    ...
    responsive: ["Dialog uses full viewport width below `640px` with reduced top padding."],
...
export const categoryQuality = {
  ...
  content: {
    ...
    responsive: [
      "Charts, tables, and cards scale to container width; overflow scrolls internally.",
    ],
